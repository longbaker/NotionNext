...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '6df4279b6b6a4bcf81284cb09122d8a2',
  ...
  AUTHOR: '万有引力', // 作者
  BIO: '伟大的意义在于坚持不懈', // 作者简介
  LINK: 'https://nt.acevs.com', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/longbaker', // 你的github个人主页
